...
// #include <linux/netfilter/nf_ipt_webstr.h>
...
#define IPT_WEBSTR_URL 0
#define IPT_WEBSTR_HOST 1
#define IPT_WEBSTR_CONTENT 2
...
/* this is the main function that does business */
...
//    proc_ipt_search search=search_linear;
    ...
    char token[] = "<&nbsp;>";
    char *wordlist = (char *)&info->string; /* list of words to match? */
    httpinfo_t htinfo;
    int flags = 0;
    int found = 0;
    long int opt = 0;
    ...
    if (!ip || info->len < 1) /* no matching rules since length < 1 ? */
        return 0;
