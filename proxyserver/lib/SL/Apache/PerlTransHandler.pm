...
BEGIN {
    ...
    my @user_agents = qw( Camino Firefox IE Opera Mozilla Safari libscrobbler 
                          Links Lynx);
...
use Apache2::Const -compile => qw( OK SERVER_ERROR NOT_FOUND DECLINED CONN_KEEPALIVE);
