...
$dbh->do("update ad_size set css_url=qq[$css_url] where ad_size_id = 1");
...
CSS
$dbh->do("update ad_size set css_url=qq[$css_url] where ad_size_id = 2");
...
CSS
$dbh->do("update ad_size set css_url=qq[$css_url] where ad_size_id = 3");
...
CSS
$dbh->do("update ad_size set css_url=qq[$css_url] where ad_size_id = 4");
...
CSS
$dbh->do("update ad_size set css_url=qq[$css_url] where ad_size_id = 5");
...
CSS
$dbh->do("update ad_size set css_url=qq[$css_url] where ad_size_id = 6");
...
qq[$css_url] = <<CSS;
<link rel="stylesheet" href="http://www.silverliningnetworks.com/resources/css/sl_double_fb_ss.css" type="text/css" /><script type="text/javascript" src="http://www.silverliningnetworks.com/resources/js/jquery.js"></script><script type="text/javascript">\$(document).ready(function() { \$(\'a#silver_lining_close\').click(function() {\$(\'div#silver_lining_ad_horizontal\').hide("slow"); \$(\'div#silver_lining_double_ad_fb').css("top", "0")});\$(\'a#silver_lining_close_vert').click(function(){\$(\'div#silver_lining_double_ad_fb').hide("slow");\$(\'div#silver_lining_skyscraper_webpage').css("margin-left", "0px");});});</script>
CSS
$dbh->do("update ad_size set css_url=qq[$css_url] where ad_size_id = 7");
$dbh->do("update ad_size set template='double_fullbanner_skyscraper.tmpl' where ad_size_id = 7");

##############################
qq[$css_url] = <<CSS;
<link rel="stylesheet" href="http://www.silverliningnetworks.com/resources/css/sl_double_lb_ss.css" type="text/css" /><script type="text/javascript" src="http://www.silverliningnetworks.com/resources/js/jquery.js"></script><script type="text/javascript">\$(document).ready(function(){\$(\'a#silver_lining_close\').click(function(){\$(\'div#silver_lining_ad_horizontal\').hide("slow");\$(\'div#silver_lining_double_ad_lb').css("top", "0")});\$(\'a#silver_lining_close_vert').click(function(){\$(\'div#silver_lining_double_ad_lb').hide("slow");\$(\'div#silver_lining_skyscraper_webpage').css("margin-left", "0px");});});</script>
CSS
$dbh->do("insert into ad_size (ad_size_id, name, css_url, bug_height, bug_width, template) values (8, 'Leaderboard & Skyscraper', qq[$css_url], 90, 120, 'double_leaderboard_skyscraper.tmpl') ");


##############################
qq[$css_url] = <<CSS;
<link rel="stylesheet" href="http://www.silverliningnetworks.com/resources/css/sl_double_lb_wss.css" type="text/css" /><script type="text/javascript" src="http://www.silverliningnetworks.com/resources/js/jquery.js"></script><script type="text/javascript">\$(document).ready(function(){\$(\'a#silver_lining_close\').click(function(){\$(\'div#silver_lining_ad_horizontal\').hide("slow");\$(\'div#silver_lining_double_ad_lb').css("top", "0")});\$(\'a#silver_lining_close_vert').click(function(){\$(\'div#silver_lining_double_ad_lb').hide("slow");\$(\'div#silver_lining_wideskyscraper_webpage').css("margin-left", "0px");});});</script>
CSS
$dbh->do("insert into ad_size (ad_size_id, name, css_url, bug_height, bug_width, template) values (9, 'Leaderboard & Wide Skyscraper', qq[$css_url], 90, 160, 'double_leaderboard_wide_skyscraper.tmpl') ");
...
CSS
$dbh->do("insert into ad_size (ad_size_id, name, css_url, bug_height, bug_width, template) values (10, 'Floating Leaderboard', qq[$css_url], 90, 200, 'floating_leaderboard.tmpl') ");
...
$dbh->do("insert into ad_size (ad_size_id, name, css_url, bug_height, bug_width, template) values (11, 'Floating Full Banner', qq[$css_url], 60, 200, 'floating_full_banner.tmpl') ");
