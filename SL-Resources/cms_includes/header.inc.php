<?php include('cms_includes/title.inc.php');?>
...
<head>
  ...
  <script type="text/javascript" src="resources/js/cms.js"></script>
  <title>Silver Lining Dashboard - <?php if(isset($title)){ echo($title);} ?> </title>
</head>
<body id="sln_cms">